      ...
      <div className="row center-text">
        <div className="col-1-of-2 left-text">
          <h3 className="heading-tertiary margin-bottom-s">
            Proud Puerto Rican Software Engineer in NYC
          </h3>
          ...
          <p className="paragraph">
           I'm obsessed with seeing how far the human body can be pushed when it comes to strength, endurance, and work capacity. Follow me on my journey as I go from powerlifting/strongman into training for the Edinburgh Marathon on May 27th 2020!
          </p>
